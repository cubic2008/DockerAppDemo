...
# * dockerapp-tomcat: using tomcat.df
...
echo "+------------------------------------------------------------+"
echo "| Step 1.1: Create images (dockerapp-tomcat using tomcat.df) |"
echo "+------------------------------------------------------------+"
...
echo "+-----------------------------------------------------------------+"
echo "| Step 1.3: Create images (dockerapp-nginx using nginx_tomcat.df) |"
echo "+-----------------------------------------------------------------+"
