...
![](git-resources/springmvc-tomcat-env-setup.png)
...
![](git-resources/docker-compose-up-no-image-build.png)
...
The following screenshot shows the result.
![](git-resources/docker-compose-up-with-image-build.png)
...
![](git-resources/docker-compose-down.png)
