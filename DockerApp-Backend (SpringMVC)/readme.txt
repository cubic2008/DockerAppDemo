 ...
 This will deploy two artifacts, target/maven-app.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/maven-app.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/maven-app.war

 To undeploy the application, run:

  ./asadmin undeploy maven-app
